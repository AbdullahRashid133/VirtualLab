...
#[derive(Debug)]
pub struct VirtualLabProcessor {
    verbose: bool,
    processed_count: usize,
}

impl VirtualLabProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting VirtualLab processing");
    
    let mut processor = VirtualLabProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = VirtualLabProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = VirtualLabProcessor::new(false);
